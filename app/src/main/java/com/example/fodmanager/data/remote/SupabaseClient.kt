...
// Instancia global del cliente Supabase, accesible desde cualquier parte de la aplicación
...
val supabase = createSupabaseClient(
    ...
    // Instala el módulo Storage para almacenar las fotos de las incidencias FOD
